...
import src
import src.geo2txt
from src.geo2txt.geolocator import bulk_text_toponym_lookup
from src.geo2txt.models import Base
from src.geo2txt.utils import get_geonames_and_populate_db
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="no",
        help="Initialize tables in database, defaults to: 'no'",
    )
    parser.add_argument(
        "--start_after",
        dest="START_AFTER",
        type=int,
        default=None,
        help="Batch for bulk toponym lookup starts after this report ID.",
    )
    parser.add_argument(
        "--end",
        dest="END",
        type=int,
        default=None,
        help="Batch for bulk toponym lookup ends with this report ID.",
    )
    ...
    logging.basicConfig(
        filename=Path.joinpath(log_path, "geo2txt.log"),
